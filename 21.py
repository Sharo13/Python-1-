...
adrs1 = Address("Tbilisi", "Saburtalo")
adrs2 = Address("Tbilisi", "Gldani-7-11-4-93")
adrs3 = Address("Tbilisi", "Leselidzs str. 25")
adrs4 = Address("Tbilisi", "Varketili IV 407-5-123")

student1 = Student("Paata", 87, adrs1)
student2 = Student("Demetre", 100, adrs2)
student3 = Student("Alexander", 100, adrs2)
student4 = Student("Teona", 92, adrs2)
student5 = Student("Nino", 99, adrs3)
student6 = Student("Andria", 87, adrs4)
